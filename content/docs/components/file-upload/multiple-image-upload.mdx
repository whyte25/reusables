...
```json doc-gen:file
{
  "file": "registry/default/reusables/multiple-image-upload.tsx",
  "codeblock": {
    "lang": "tsx",
...
<ComponentSource
  className="md:px-0"
  name="example/auto-multiple-image-upload-demo"
  reTrigger={true}
/>
...
<ComponentSource
  className="md:px-0"
  name="example/manual-multiple-image-upload-demo"
  reTrigger={true}
/>
...
<ComponentSource
  className="md:px-0"
  name="example/multiple-image-upload-form-demo"
  reTrigger={true}
/>
