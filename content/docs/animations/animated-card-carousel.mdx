...
description: A component that creates an animated card carousel with customizable transitions, perfect for showcasing projects, testimonials, or featured content.
---
