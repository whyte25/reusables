        ...
        <div className="relative px-4">
          <div className="text-center">
            ...
            >
              ...
              >
                <AnimatedGradientText className="rounded-full border">
                  🎉 <hr className="mx-2 h-4 w-px shrink-0 bg-gray-300" />{" "}
                  <span className={cn("animate-gradient inline")}>
                    Reusables
                  </span>
            ...
            <motion.h1
              className="font-display mx-auto max-w-4xl text-5xl font-medium tracking-tight sm:text-7xl"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.3 }}
            >
