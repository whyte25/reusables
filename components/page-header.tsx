...
function PageHeaderHeading({
  ...
  return (
    <h1
      className={cn(
        "leading-tighter max-w-2xl text-balance text-4xl font-semibold tracking-tight text-primary lg:font-semibold lg:leading-[1.1] xl:text-5xl xl:tracking-tighter",
        className
      )}
      {...props}
    />
